...
class Category(models.Model):
    category = models.CharField(max_length=100, null=False, blank=False, verbose_name='Наименование категории')
...
class Product(models.Model):
    ...
    coast = models.DecimalField(max_digits=20, decimal_places=2, null=False, verbose_name='Стоимость')
